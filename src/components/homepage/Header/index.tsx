    ...
    <header className="bg-[#F2F0F1] pt-10 md:pt-24 overflow-hidden">
      <div className="md:max-w-frame mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <section className="max-w-frame px-4">
          ...
          >
            Fruit Powders And Masalas, Perfected by NBRK
          </motion.h2>
          <motion.p
          ...
          >
           At NBRK Manufacturing, we blend the finest fruits, vegetables, and spices into powders and masalas tailored for your needs.
          </motion.p>
          <motion.div
            initial={{ y: "100px", opacity: 0 }}
            whileInView={{ y: "0", opacity: 1 }}
        ...
        <motion.section
          initial={{ y: "200px", opacity: 0, rotate: 10 }}
          whileInView={{ y: "0", opacity: 1, rotate: 0 }}
          viewport={{ once: true }}
          transition={{ delay: 2.3, duration: 0.8 }}
          className="relative  md:px-4 min-w-[200px]  min-h-[400px] md:min-h-[428px] bg-cover bg-top xl:bg-[center_top_-1.6rem] bg-no-repeat bg-[url('/nbrk-banner.png')] md:bg-[url('/nbrk-banner.png')]"
        >
          <Image
            priority
